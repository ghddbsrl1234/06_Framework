...
SELECT FILE_NO, FILE_RENAME, MEMBER_NICKNAME, TO_CHAR(FILE_UPLOAD_DATE, 'YYYY-MM-DD') FILE_UPLOAD_DATE, FILE_PATH
FROM "UPLOAD_FILE" JOIN "MEMBER" ON("UPLOAD_FILE".MEMBER_NO = "MEMBER".MEMBER_NO)

...
memberEmail.addEventListener("input", e => {
    ...
    fetch("/member/checkEmail?memberEmail=" + inputEmail)
        ...
        .then(count => {
            ...
            checkObj.memberEmail = true; // 유효한(정규식 검사, 중복 검사 모두 통과) 이메일
...
checkAuthKeyBtn.addEventListener("click", () => {
    ...
    .then(result => {
            ...
            checkAuthKeyBtn.innerText = "인증 완료"
            checkAuthKeyBtn.style.backgroundColor = "#EEEEEE";
            checkAuthKeyBtn.style.cursor = "default";

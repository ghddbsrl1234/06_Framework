...
public class ExampleController {
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		// src/main/resources/templates/example/ex1.html 로 froward
		return "example/ex1";
	}
	
	@PostMapping("ex2") // example/ex2 POST 바식 요청 매핑
	public String ex2(Model model) {
		
		model.addAttribute("str", "<h1> 테스트 중 &times; </h1>"); // request scope

		// src/main/resources/templates/example/ex2.html 로 froward
		return "example/ex2";
	}
